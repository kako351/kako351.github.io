...
const activeProducts: Product[] = [
  {
    name: "ひつだん",
    platform: "Android",
    description: "音声でのコミュニケーションが困難な場面（医療・騒音環境など）で使える筆談アプリ。シンプルなUIと大きな文字表示にこだわり設計。",
    tech: "Kotlin, Jetpack Compose, Room DB",
    achievement: "2万DL以上 / アプリ内課金実装",
  ...
  },
  {
    ...
    description: "コーヒーの抽出記録をSNS風UIで共有・管理できるアプリ。iOS/Android両対応で、個人では初のiOSリリース。",
    tech: "Flutter, Dart, Firebase, Supabase",
    achievement: "iOS/Android クロスプラットフォーム / SNS機能（投稿・フォロー）実装",
  ...
  },
  {
    ...
    platform: "Android",
    description: "シャッター音なしで最高画質撮影ができるカメラアプリ。Camera2 APIを直接操作することで高品質な撮影体験を実現。",
    tech: "Kotlin, Camera2 API",
  ...
  },
  {
    name: "トイピアノ",
    platform: "WearOS",
    description: "WearOSスマートウォッチで動作するトイピアノアプリ。Watch専用UIの設計・WearOS特有のAPI対応を経験。",
    tech: "Kotlin, Jetpack Compose for Wear OS",
