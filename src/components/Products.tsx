...
const activeProducts: Product[] = [
  ...
  },
  {
    ...
    tech: "Kotlin, Play Billing Library, MLKit",
  ...
  },
  {
    name: "コーヒーコンパス",
    platform: "iOS / Android",
    description: "コーヒーの記録をSNS風UIで共有・管理できるアプリ。iOS/Android両対応で、個人では初のiOSリリース。",
  ...
  },
  {
    ...
    platform: "Android",
    description: "シャッター音なしで最高画質撮影ができるカメラアプリ。高品質な撮影体験を実現。",
    tech: "Kotlin, CameraX",
